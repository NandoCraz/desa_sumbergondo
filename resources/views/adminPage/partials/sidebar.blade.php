...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    @if (auth()->user()->role == 'admin')
        ...
        <li class="nav-item {{ Request::Is('pesanan*') ? 'active' : '' }}">
            ...
            <div id="pesananUtilities" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
    ...
    <li class="nav-item {{ Request::Is('bank-sampah*') ? 'active' : '' }}">
        ...
        <div id="bankUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="/bank-sampah/data-bank"><i class="fa fa-table text-primary mr-2"
                        aria-hidden="true"></i>Data Bank</a>
                <a class="collapse-item" href="/bank-sampah/komposter"><i class="fa fa-credit-card text-danger mr-2"
                        aria-hidden="true"></i>Tagihan Komposter</a>
            </div>
        </div>
    </li>
